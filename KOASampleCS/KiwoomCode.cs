...
namespace KiwoomCode
{
	...
	class KOABiddingType
	{
		...
		public const String LIMIT_PRICE = "00";
		public const String MARKET_PRICE = "03";
		public const String BEFORE_MARKET_EXTRA_TIME_CLOSING_PRICE = "61";
		public const String EXTRA_TIME_SINGLE_PRICE = "62";
		public const String AFTER_MARKET_EXTRA_TIME_CLOSING_PRICE = "81";
	}
    ...
    public class KOACode
    {
        ...
        static KOACode()
        {
            ...
            hogaGb[2] = new HogaGb("61", "장전시간외종가");
            hogaGb[3] = new HogaGb("62", "시간외단일가매매");
            hogaGb[4] = new HogaGb("81", "장후시간외종가");
